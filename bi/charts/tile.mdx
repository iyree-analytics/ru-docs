...
<ResponseField name="data_point_actions" type="DataPointActionDefinition[]">
  ...
  data_point_actions:
    - id: "action-1"
      ...
      target_page_id: "sales-details"
      filter_mappings:
        - target_filter_id: "period"
          sources:
            - type: source_dashboard_filter
              source_filter_id: "main_date_filter"
  ```
</ResponseField>
...
## Multi Tile — Несколько показателей {#multi-tile}
