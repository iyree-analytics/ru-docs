...
<img
  src="/assets/img/charts/table_v2/table_v2_example.png"
  width="300"
  alt="Пример Table V2 графика"
/>
...
<ResponseField name="columns" type="TableColumn[]" required>
  ...
  <Expandable title="Типы колонок">
    ...
    <ResponseField name="data_point_actions" type="DataPointActionDefinition[]">
      Действия при клике на ячейку. Можно использовать только в колонках с типом "measure".
...
<ResponseField name="sorting" type="TableSorting[]">
  Сортировка данных

  <Expandable title="Структура TableSorting">
    <ResponseField name="member" type="string" required>
...
<CardGroup cols={2}>
  <Card icon="sitemap" href="../features/dimension-hierarchy" title="Иерархии измерений">
    Drill-down и группировка строк
  </Card>
  <Card icon="palette" href="../features/conditional-formatting" title="Условное форматирование">
    Цвета, градиенты, иконки
  </Card>
  <Card icon="mouse-pointer-click" href="../features/data-point-actions" title="Действия с данными">
    Drill-through и ссылки
  </Card>
  <Card icon="layer-group" href="../features/dimensions" title="Измерения">
    Типы измерений
  </Card>
</CardGroup>
